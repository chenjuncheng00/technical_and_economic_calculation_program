Public Class 设置补贴收入计算年限
    ...
    Private Sub 补贴收入1_Click(sender As Object, e As EventArgs) Handles 补贴收入1.Click
        ...
        If Me.CheckBox1.Checked = True And Me.CheckBox2.Checked = True Then
            ...
            Exit Sub
        End If
        If Me.CheckBox1.Checked = True And Me.CheckBox3.Checked = True Then
            MsgBox("补贴收入逐年计算比例仅可以勾选一种计算模式，请重新选择！")
            Exit Sub
        End If
        ...
        If Me.CheckBox1.Checked = True Then
            ...
            For j = 0 To n_nf - 1
                '前15年
                For i = 3 To 17
                    If ExcelApp.ThisWorkbook.Worksheets("收入税收表").Cells(162, i).Value >= ksnf_list(j) And ExcelApp.ThisWorkbook.Worksheets("收入税收表").Cells(162, i).Value <= jsnf_list(j) And ExcelApp.ThisWorkbook.Worksheets("收入税收表").Cells(162, i).Value <= jsnx Then
            ...
            For Each qtnf In qtnf_list
                '前15年
                For i = 3 To 17
                    If ExcelApp.ThisWorkbook.Worksheets("收入税收表").Cells(162, i).Value = qtnf Or ExcelApp.ThisWorkbook.Worksheets("收入税收表").Cells(162, i).Value > jsnx Then
        ...
        For i = 3 To 33  '根据数组中的元素数量循环
            If i - 2 <= jsnx Then
                ...
                Me.RichTextBox1.Text = Me.RichTextBox1.Text & btsrbl1 & "%(" & nf & ") " '输出到RichTextBox1
            End If
        Next
    ...
    Private Sub 补贴收入2_Click(sender As Object, e As EventArgs) Handles 补贴收入2.Click
        ...
        For i = 3 To 33  '根据数组中的元素数量循环
            If i - 2 <= jsnx Then
                ...
                Me.RichTextBox1.Text = Me.RichTextBox1.Text & btsrbl2 & "%(" & nf & ") " '输出到RichTextBox1
            End If
        Next
    ...
    Private Sub 光伏补贴收入_Click(sender As Object, e As EventArgs) Handles 光伏补贴收入.Click
        ...
        For i = 3 To 33  '根据数组中的元素数量循环
            If i - 2 <= jsnx Then
                ...
                Me.RichTextBox1.Text = Me.RichTextBox1.Text & gfbtsr & "%(" & nf & ") " '输出到RichTextBox1
            End If
        Next
    ...
    Private Sub 设置补贴收入计算年限_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Me.开始年份tmp.Clear()
        Me.结束年份tmp.Clear()
        Me.补贴收入1.Text = Nothing
        Me.补贴收入2.Text = Nothing
        Me.CheckBox1.Checked = False
        Me.CheckBox2.Checked = False
        Me.CheckBox3.Checked = False
        Me.RichTextBox1.Rtf = Nothing
        Me.RichTextBox1.Clear()
        '载入按钮文本
        Me.补贴收入1.Text = CType(ExcelApp.ThisWorkbook.Worksheets("收入&成本输入").Cells(24, 2).Value, String)
        Me.补贴收入2.Text = CType(ExcelApp.ThisWorkbook.Worksheets("收入&成本输入").Cells(25, 2).Value, String)
        '载入默认值
